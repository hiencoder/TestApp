...
public class StringUtils {
	...
	public static String convertCp1252ToShiftJIS(String source) {
		if (TextUtils.isEmpty(source)) {
			return source;
		} else {
			try {
				byte[] strInByte = source.getBytes(StringUtils.SHIFT_JIS_CHARSET);
				String encodedString = new String(strInByte, StringUtils.UTF_8_CHARSET);
